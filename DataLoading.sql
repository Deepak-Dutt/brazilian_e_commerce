...
load data infile "data/clean_data/customers.csv"
...
load data infile "data/clean_data/items.csv"
into table items
fields terminated by ','
enclosed by '"'
lines terminated by '\n'
...
load data infile "data/clean_data/payments.csv"
into table payments
fields terminated by ','
enclosed by '"'
lines terminated by '\n'
...
load data infile "data/clean_data/reviews.csv"
into table reviews
fields terminated by ','
enclosed by '"'
lines terminated by '\n'
...
load data infile "data/clean_data/orders.csv"
into table orders
fields terminated by ','
enclosed by '"'
lines terminated by '\n'
...
load data infile "data/clean_data/products.csv"
into table products
fields terminated by ','
enclosed by '"'
lines terminated by '\n'
...
load data infile "data/clean_data/sellers.csv"
into table sellers
fields terminated by ','
enclosed by '"'
lines terminated by '\n'
...
load data infile "data/clean_data/names.csv"
into table names
fields terminated by ','
enclosed by '"'
lines terminated by '\n'
...
load data infile "data/clean_data/geolocations.csv"
